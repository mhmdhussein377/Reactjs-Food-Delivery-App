      ...
      <Container>
        <Row>
          ...
          <Col lg="3" md="4" sm="6">
            ...
            <ListGroup className="deliver__time_list">
              <ListGroupItem className="deliver__time-item border-0 ps-0">
                <span>Location: Saida, Lebanon</span>
              </ListGroupItem>

              <ListGroupItem className=" deliver__time-item border-0 ps-0">
                <span>Phone: 81 954 732</span>
              </ListGroupItem>

              <ListGroupItem className="deliver__time-item border-0 ps-0">
                <span>Email: mohammad.hussein377@gmail.com</span>
              </ListGroupItem>
            </ListGroup>
          </Col>
          <Col lg="3" md="4" sm="6">
        ...
        <Row className='mt-5'>
          <Col lg="6" md="6">
            <p className='copyright__text'>
              Copyright - 2022, website made by Mhmd Hussein. All Rights
              Reserved
            </p>
          </Col>
